...
const createData = (elementData) => {
 ...
 const openPictureLink = document.querySelector('.popup-img__figure_type_photo-open');
 const openPictureName = document.querySelector('.popup-img__figure_type_place-open');
